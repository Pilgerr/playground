...
<body class="body-cart">
    ...
    <div class="div-search">
        ...
        <input type="text" placeholder="   Pesquise seu item" class="input-filter" name="busca" value="<?php if(isset($_GET['busca'])) echo $_GET['busca']; ?>">
        <button class="btn-filter" type="submit"><img src="https://i.im.ge/2022/09/16/1OPBhM.filter.png" alt="Filtro" width="20px" height="20px" id="img-filter"></button>
        </form>
    </div>
